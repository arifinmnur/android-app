...
class OutputApiImpl(
  ...
  override suspend fun getOutputs(): Either<Throwable, OutputResponse> = Either.catch {
    apiBase.getItem(Protocol.PlayerOutput, OutputResponse::class)
  }

  override suspend fun setOutput(active: String): Either<Throwable, OutputResponse> = Either.catch {
