...
val appModule = module {
  ...
  single<RequestManager> { RequestManagerImpl(get(), get(), get(), get(), get()) }
  ...
  single<PlayingTrackCache> { PlayingTrackCacheImpl(get(), get()) }
  ...
  single { UpdateCover(get(), get(), get(), get(), get()) }
